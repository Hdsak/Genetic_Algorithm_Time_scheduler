...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Аудитория"))
        self.lblName.setText(_translate("Dialog", "Название"))
        self.groupBox.setTitle(_translate("Dialog", "Тип"))
        self.radioLec.setText(_translate("Dialog", "Лекционная"))
        self.radioLab.setText(_translate("Dialog", "Лабораторная"))
        self.btnFinish.setText(_translate("Dialog", "Завершить"))
