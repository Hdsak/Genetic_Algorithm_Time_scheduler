...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Предмет"))
        self.lblHours.setText(_translate("Dialog", "Часы/Неделя"))
        self.lblName.setText(_translate("Dialog", "Название"))
        self.groupBox_2.setTitle(_translate("Dialog", "Разделить расписание"))
        self.radioYes.setText(_translate("Dialog", "Да"))
        self.radioNo.setText(_translate("Dialog", "Нет"))
        self.groupBox.setTitle(_translate("Dialog", "Тип"))
        self.radioAny.setText(_translate("Dialog", "Любой"))
        self.radioLec.setText(_translate("Dialog", "Лекция"))
        self.radioLab.setText(_translate("Dialog", "Лабораторная"))
        self.lblCode.setText(_translate("Dialog", "Код"))
        self.lblDesc.setText(_translate("Dialog", "Описание"))
