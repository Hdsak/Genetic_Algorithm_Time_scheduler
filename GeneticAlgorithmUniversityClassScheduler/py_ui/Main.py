...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Ибатуллов Тимур Составление расписаний с помощью ген. алгоритма"))
        ...
        self.btnInstrAdd.setText(_translate("MainWindow", "Добавить преподавателя"))
        self.btnInstrImport.setText(_translate("MainWindow", "Import from CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabInstructors), _translate("MainWindow", "Преподаватели"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Действия"))
        self.btnRoomAdd.setText(_translate("MainWindow", "Добавить аудиторию"))
        self.btnRoomImport.setText(_translate("MainWindow", "Import from CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRooms), _translate("MainWindow", "Аудитории"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Действия"))
        self.btnSubjAdd.setText(_translate("MainWindow", "Добавить предмет"))
        ...
        self.btnSecAdd.setText(_translate("MainWindow", "Добавить в группу"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSections), _translate("MainWindow", "Группы"))
        self.groupBox_5.setTitle(_translate("MainWindow", "Действия"))
        self.btnScenGenerate.setText(_translate("MainWindow", "Сгенерировать"))
        self.btnScenResult.setText(_translate("MainWindow", "Показать Результаты"))
        self.groupBox_6.setTitle(_translate("MainWindow", "Настройка университета"))
        self.radioLunchYes.setText(_translate("MainWindow", "Да"))
        self.radioLunchNo.setText(_translate("MainWindow", "Нет"))
        self.label_6.setToolTip(_translate("MainWindow", "Доступ к перерыву на обед для групп"))
        self.label_6.setText(_translate("MainWindow", "Обеденный перерыв"))
        self.label_4.setToolTip(_translate("MainWindow", "Когда открывается университет"))
        self.label_4.setText(_translate("MainWindow", "Начало занятий"))
        self.timeStarting.setDisplayFormat(_translate("MainWindow", "h AP"))
        self.label_5.setToolTip(_translate("MainWindow", "Закрытие университета"))
        self.label_5.setText(_translate("MainWindow", "Окончание занятий"))
        ...
        self.label_20.setToolTip(_translate("MainWindow", "Процент элитарных поколений"))
        self.label_20.setText(_translate("MainWindow", "Элитарное поколение "))
        ...
        self.label_12.setToolTip(_translate("MainWindow", "Остановить генерацию когда поколение встретиться с этой хромосомой"))
        self.label_12.setText(_translate("MainWindow", "Наивысшая функция приспособляемости"))
        ...
        self.label_11.setText(_translate("MainWindow", "Триггер мутации"))
        self.label_10.setToolTip(_translate("MainWindow", "Количество попыток для создание хромосомы"))
        self.label_10.setText(_translate("MainWindow", "Макс кол-во попыток"))
        self.label_9.setToolTip(
            _translate("MainWindow", "Максимальное количество популяций"))
        self.label_9.setText(_translate("MainWindow", "Максимум поколений"))
        self.label_7.setToolTip(
            _translate("MainWindow", "Минимальное значение популяции, точка инициализации"))
        self.label_7.setText(_translate("MainWindow", "Минимальная популяция"))
        self.label_8.setToolTip(_translate("MainWindow", "Наибольшая популяция"))
        self.label_8.setText(_translate("MainWindow", "Наибольшая популяция"))
        self.groupBox_9.setTitle(_translate("MainWindow", "Матрица эвалуации"))
        self.label_15.setToolTip(_translate("MainWindow",
                                            "Веса"))
        self.label_15.setText(_translate("MainWindow", "Отдах группы"))
        self.label_18.setToolTip(_translate("MainWindow", "Вес для отдыха группы"))
        self.label_18.setText(_translate("MainWindow", "Простой группы"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabScenario),
                                  _translate("MainWindow", "Менеджер сценариев"))
        ...
        self.actionAdd_Instructor.setText(_translate("MainWindow", "Добавить преподавателя"))
        self.actionView_Instructors.setText(_translate("MainWindow", "Посмотреть преподавателя"))
        self.actionAdd_Room.setText(_translate("MainWindow", "Добавить аудиторию"))
        self.actionView_Rooms.setText(_translate("MainWindow", "Посмотреть аудиторию"))
        self.actionAdd_Subject.setText(_translate("MainWindow", "Добавить предмет"))
        self.actionView_Subjects.setText(_translate("MainWindow", "Посмотреть предметы"))
        self.actionAdd_Sections.setText(_translate("MainWindow", "Добавить группу"))
        self.actionView_Sections.setText(_translate("MainWindow", "Посмотреть группы"))
        self.actionImport.setText(_translate("MainWindow", "Import"))
        self.actionExport.setText(_translate("MainWindow", "Export"))
        self.actionView_Results.setText(_translate("MainWindow", "Посмотреть результаты"))
        ...
        self.actionScenario_Summary.setText(_translate("MainWindow", "Итог сценария"))
        self.actionGenerate_2.setText(_translate("MainWindow", "Generate"))
        self.actionView_Results_2.setText(_translate("MainWindow", "Посмотреть результаты"))
        self.actionInstructions.setText(_translate("MainWindow", "Инструкции"))
