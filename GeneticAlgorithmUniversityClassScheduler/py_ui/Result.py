...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Категории"))
        self.cmbCategory.setItemText(0, _translate("Dialog", "Группа"))
        self.cmbCategory.setItemText(1, _translate("Dialog", "Аудитория"))
        self.cmbCategory.setItemText(2, _translate("Dialog", "Преподаватель"))
        self.groupBox_2.setTitle(_translate("Dialog", "Entry"))
        self.groupBox_6.setTitle(_translate("Dialog", "Действия"))
        ...
        self.lblSbj.setText(_translate("Dialog", "Расположение группы: "))
        self.lblSecRest.setText(_translate("Dialog", "Отдых группы: "))
        self.lblSecIdle.setText(_translate("Dialog", "Окна группы:"))
        self.lblInstrRest.setText(_translate("Dialog", "Отдых преподавателя: "))
        self.lblInstrLoad.setText(_translate("Dialog", "Нагрузка преподавателя:"))
        self.lblLunch.setText(_translate("Dialog", "Перерыв на обед:"))
        self.lblMeet.setText(_translate("Dialog", "Тип встречи: "))
